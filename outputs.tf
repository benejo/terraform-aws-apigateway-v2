...
# route
output "apigatewayv2_connect_route_id" {
 description = "The connect route identifier."
 value       = try(aws_apigatewayv2_route.this["$connect"].id, "")
}

output "apigatewayv2_disconnect_route_id" {
 description = "The disconnect route identifier."
 value       = try(aws_apigatewayv2_route.this["$disconnect"].id, "")
}

output "apigatewayv2_statusupdate_route_id" {
 description = "The statusupdate route identifier."
 value       = try(aws_apigatewayv2_route.this["statusupdate"].id, "")
}

output "apigatewayv2_default_route_id" {
 description = "The default route identifier."
 value       = try(aws_apigatewayv2_route.this["$default"].id, "")
}
